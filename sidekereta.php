<?php
    ...
    $result = read("SELECT * FROM transportation");
    ...
    <div class="col-md-10">
      <nav class="navbar navbar-expand-sm navbar-light border-bottom">
        ...
        <div class="content mt-5 pt-4 text-center">
            <h3 class=""> NAMA-NAMA KERETA API YANG DIPESAN<span class="text-info"></span></h3>
        </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $data["seat_qty"]; ?></td>
                  <td>
                       <a class="btn btn-info" href="editkere.php?id=<?= $data["id"] ; ?>">Edit</a>
                     <a class="btn btn-danger" href="hapuskere.php?id=<?= $data["id"] ; ?>" onclick = "return confirm('Yakin Ingin Menghapus Data ???')">Hapus</a>
                  </td>
