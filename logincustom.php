<?php
  ...
  if(isset($_POST["login"])) {
    if (login($_POST) > 0 ) {
      echo "<script>
              alert ('Berhasil Login Sebagai Customer') ;
              window.location.href = 'reservation.php' ;
            </script>";
    }else {
        echo "<script>
              alert ('GAGALL!!!! Login Sebagai Customer Silahkan Daftar Dulu') ;
      ...
      <div class="container">
       ...
       <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        ...
        <div class="row justify-content-center">
           <div class="col-md-4">
            <div class="card mt-5">
             <div class="card-header"><h5 class="text-center font-weight-bold">LOGIN SEBAGAI <span class="font-weight-bold text-warning">CUSTOMER</span></h5></div>
            <div class="card-body">
            <form action="" method="post">
              
                <div class="form-group mt-3">
                    <label for="username">Username</label>
                    <input type="text" class="form-control" name="nama"  id="username" placeholder="Username">
                </div>
                ...
                <p class="text-center mt-2">Belum ada Akun ? <a href="daftarcustom.php"> Daftar Di Sini</a></p>
