<?php
    ...
    $result = read("SELECT * FROM reservation");
    ...
    <div class="col-md-10">
      <nav class="navbar navbar-expand-sm navbar-light border-bottom">
        ...
        <div class="content mt-5 pt-4 text-center">
            <h3 class=""> Detail Pemberangkatan Kereta Api <span class="text-info"></span></h3>
        </div>
            <a class="btn btn-danger" href="tambah_rese.php">TAMBAH DETAIL</a>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $data["price"]; ?></td>
                   <td><?= $data["userid"]; ?></td>
                  <td>
                      <a class="btn btn-info" href="booking.php"><i class="fas fa-envelope"> Pesan</a></i>
                  </td>
