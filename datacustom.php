<?php
  ...
  $result = read("SELECT * FROM customer");
    ...
    <div class="col-md-10">
      <nav class="navbar navbar-expand-sm navbar-light border-bottom">
        ...
        <div class="content mt-5 pt-4 text-center">
            <h3 class="">DATA - DATA CUSTOMER <span class="text-info"></span></h3>
        </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $data["gender"]; ?></td>
                  <td>
                     <a class="btn btn-danger" href="hapuscustom.php?id=<?= $data["id"] ; ?>" onclick = "return confirm('Yakin Ingin Menghapus Data ???')">Hapus</a>
                  </td>
